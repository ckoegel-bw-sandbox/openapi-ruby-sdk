...
# Unit tests for RubySdk::CreateCallRequest
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubySdk::CreateCallRequest do
  let(:instance) { RubySdk::CreateCallRequest.new }

  describe 'test an instance of CreateCallRequest' do
    it 'should create an instance of CreateCallRequest' do
      expect(instance).to be_instance_of(RubySdk::CreateCallRequest)
    end
  end
  ...
  describe 'test attribute "answer_method"' do
    it 'should work' do
      ...
      #   expect { instance.answer_method = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "answer_fallback_method"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["POST", "GET"])
      # validator.allowable_values.each do |value|
      #   expect { instance.answer_fallback_method = value }.not_to raise_error
      # end
    end
  end
  ...
  describe 'test attribute "disconnect_method"' do
    it 'should work' do
      ...
      # validator = Petstore::EnumTest::EnumAttributeValidator.new('String', ["POST", "GET"])
      # validator.allowable_values.each do |value|
      #   expect { instance.disconnect_method = value }.not_to raise_error
      # end
    end
  end
