...
# Unit tests for RubySdk::ConferenceRecordingMetadata
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubySdk::ConferenceRecordingMetadata do
  let(:instance) { RubySdk::ConferenceRecordingMetadata.new }
  ...
  describe 'test an instance of ConferenceRecordingMetadata' do
    it 'should create an instance of ConferenceRecordingMetadata' do
      expect(instance).to be_instance_of(RubySdk::ConferenceRecordingMetadata)
    end
  end
