...
# Unit tests for RubySdk::Subscriptions
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubySdk::Subscriptions do
  let(:instance) { RubySdk::Subscriptions.new }

  describe 'test an instance of Subscriptions' do
    it 'should create an instance of Subscriptions' do
      expect(instance).to be_instance_of(RubySdk::Subscriptions)
    end
  end
