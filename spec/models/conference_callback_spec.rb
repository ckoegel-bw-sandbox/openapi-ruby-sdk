...
# Unit tests for RubySdk::ConferenceCallback
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubySdk::ConferenceCallback do
  let(:instance) { RubySdk::ConferenceCallback.new }

  describe 'test an instance of ConferenceCallback' do
    it 'should create an instance of ConferenceCallback' do
      expect(instance).to be_instance_of(RubySdk::ConferenceCallback)
    end
  end
