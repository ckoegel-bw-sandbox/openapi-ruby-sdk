...
# Unit tests for RubySdk::CreateCallResponse
# Automatically generated by openapi-generator (https://openapi-generator.tech)
# Please update as you see appropriate
describe RubySdk::CreateCallResponse do
  let(:instance) { RubySdk::CreateCallResponse.new }

  describe 'test an instance of CreateCallResponse' do
    it 'should create an instance of CreateCallResponse' do
      expect(instance).to be_instance_of(RubySdk::CreateCallResponse)
    end
  end
