    ...
    def operation_server_settings
      {
        ...
        "ConferencesApi.get_conference_recordings": [
          {
          url: "https://voice.bandwidth.com",
          description: "Voice API",
          }
        ...
        "ConferencesApi.modify_conference": [
          {
          url: "https://voice.bandwidth.com",
          description: "Voice API",
          }
        ],
        "ConferencesApi.modify_conference_member": [
          {
          url: "https://voice.bandwidth.com",
          description: "Voice API",
          }
        ],
        "MFAApi.messaging_two_factor": [
          {
          url: "https://mfa.bandwidth.com/api/v1",
          description: "Messaging API",
          }
        ],
        "MFAApi.verify_two_factor": [
          {
          url: "https://mfa.bandwidth.com/api/v1",
          description: "Messaging API",
          }
        ],
        "MFAApi.voice_two_factor": [
          {
          url: "https://mfa.bandwidth.com/api/v1",
          description: "Messaging API",
          }
        ...
        "ParticipantsApi.create_participant": [
          {
          url: "https://api.webrtc.bandwidth.com/v1",
          description: "Messaging API",
          }
        ],
        "ParticipantsApi.delete_participant": [
          {
          url: "https://api.webrtc.bandwidth.com/v1",
          description: "Messaging API",
          }
        ],
        "ParticipantsApi.get_participant": [
          {
          url: "https://api.webrtc.bandwidth.com/v1",
          description: "Messaging API",
          }
        ...
        "RecordingsApi.get_call_recordings": [
          {
          url: "https://voice.bandwidth.com",
          description: "Voice API",
          }
        ...
        "RecordingsApi.modify_call_recording_state": [
          {
          url: "https://voice.bandwidth.com",
          description: "Voice API",
          }
        ],
        "RecordingsApi.query_call_recordings": [
          {
          url: "https://voice.bandwidth.com",
          description: "Voice API",
          }
        ...
        "SessionsApi.list_session_participants": [
          {
          url: "https://api.webrtc.bandwidth.com/v1",
          description: "Messaging API",
          }
