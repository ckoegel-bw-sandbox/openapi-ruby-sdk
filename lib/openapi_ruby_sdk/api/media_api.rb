...
module RubySdk
  class MediaApi
    ...
    # @param media_id [String] The media ID to delete
    ...
    # @param account_id [String] User&#39;s account ID
    # @param media_id [String] The user supplied custom media ID
    # @param body [File] 
    # @param [Hash] opts the optional parameters
    ...
    def upload_media_with_http_info(account_id, media_id, body, opts = {})
      ...
      pattern = Regexp.new(/.+/)
      if @api_client.config.client_side_validation && media_id !~ pattern
        fail ArgumentError, "invalid value for 'media_id' when calling MediaApi.upload_media, must conform to the pattern #{pattern}."
      end
