  ...
  class ConferenceState
    ...
    def self.openapi_types
      {
        ...
        :'conference_event_method' => :'String',
        :'tag' => :'String',
        :'active_members' => :'Array<ConferenceMemberState>'
      }
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `RubySdk::ConferenceState` initialize method"
      end

      # check to see if the attribute exists and convert string to symbol for hash key
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.attribute_map.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `RubySdk::ConferenceState`. Please check the name to make sure it's valid. List of attributes: " + self.class.attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def valid?
      conference_event_method_validator = EnumAttributeValidator.new('String', ["POST", "GET"])
      return false unless conference_event_method_validator.valid?(@conference_event_method)
      true
    end

    # Custom attribute writer method checking allowed values (enum).
    # @param [Object] conference_event_method Object to be assigned
    def conference_event_method=(conference_event_method)
      validator = EnumAttributeValidator.new('String', ["POST", "GET"])
      unless validator.valid?(conference_event_method)
        fail ArgumentError, "invalid value for \"conference_event_method\", must be one of #{validator.allowable_values}."
      end
